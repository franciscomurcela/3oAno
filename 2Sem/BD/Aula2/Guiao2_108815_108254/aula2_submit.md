...
Produto: Preço, Codigo, Nome, Iva
PK:Codigo
FK:-

TipoFornecedor: Codigo, Designação
PK:Codigo
FK:-

CodigoPagamento: Codigo, Condicao, Prazo
PK:Codigo
FK:

Fornecedor: Codigo, Nome, Morada, NIF, Email, CondPag_Codigo, TipoForn_Codigo
PK:Codigo,
FK:CondPag_codigo, TipoForn_Codigo

Encomenda: Numero, Data, Fornecedor_codigo
PK:Numero
FK:Fornecedor_Codigo

Items: Produto_Codigo, Encomenda_Numero, Quantidade
PK:Produto_Codigo+Encomenda_Numero
FK:Produto_Codigo, Encomenda_Numero
...
```
... Write here your answer ...
Fornecedor: 1.Tipo de Pagamento, 2.Tipo de Fornecedor
Grau: Relação Ternária (Degree 3)
Cardinalidade: 1."Many-to-one" (N-1), 2."Many-to-one" (N-1)

Encomenda: 1.Fornecedor
Grau: Relação Binária (Degree 2)
Cardinalidade: 1."Many-to-one" (N-1)

TipoDePagamento: Fornecedor
Grau: Relação Binária (Degree 2)
Cardinalidade: "One-to-many" (1-N)

TipoDeFornecedor: Fornecedor
Grau: Relação Binária (Degree 2)
Cardinalidade: "One-to-many" (1-N)

Items: 1.Encomenda, 2.Produto
Grau: Relação Ternária (Degree 3)
Cardinalidade: "Many-to-one" (N-1), "Many-to-one" (N-1)
